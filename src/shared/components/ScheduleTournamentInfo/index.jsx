...
import { ScheduleTournamentInfoColumn } from 'shared/constants/TableHeaders'
import { appendParams, parseParams } from 'shared/utils'
import DataTable from '../DataTable'
import Drawer from '../Drawer'
import BonusFilters from '../BonusFilters'
import { useQuery } from 'react-query'
import { getSchedulePlayerInfo } from 'query/schedule/schedule.query'
import ScheduleTournamentInfoList from '../ScheduleTournamentInfoList'

const ScheduleTournamentInfo = ({ id, userData }) => {
    ...
    const [columns, setColumns] = useState(getSortedColumns(ScheduleTournamentInfoColumn, parsedData))
    const [modal, setModal] = useState({ open: false, type: '' })

    // List
    const { isLoading, isFetching, data } = useQuery(['schedulePlayerInfoList', requestParams], () => getSchedulePlayerInfo(id, requestParams), {
...
export default ScheduleTournamentInfo
