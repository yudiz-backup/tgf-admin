...
import { ReportStateColumns } from 'shared/constants/TableHeaders';
import DatePicker from 'react-datepicker'

const ReportListFilter = ({ filterChange, closeDrawer, defaultValue }) => {
    const { handleSubmit, control, reset } = useForm({})

    useEffect(() => {
        reset({
            eState: ReportStateColumns?.find(item => item?.value === defaultValue?.eState)
        })
    }, [defaultValue, reset])
