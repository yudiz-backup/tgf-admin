...
import { UserWithdrawalListColumn } from 'shared/constants/TableHeaders'
import { appendParams, parseParams } from 'shared/utils'
import Drawer from '../Drawer'
import DataTable from '../DataTable'
import TransactionFilter from '../TransactionFilter'
import { getUserWithdrawalList } from 'query/user/user.query'
import UserWithdrawalList from '../UserWithdrawalList'

const UserWithdrawalDetail = ({ id, buttonToggle }) => {
    ...
    const [columns, setColumns] = useState(getSortedColumns(UserWithdrawalListColumn, parsedData))
    const [modal, setModal] = useState({ open: false, type: '' })

    // List
    const { isLoading, isFetching, data } = useQuery(['userWithdrawalList', requestParams], () => getUserWithdrawalList(requestParams), {
    ...
    useEffect(() => {
        document.title = 'User Withdrawal | PokerGold'
    }, [])
    return (
        <>
            <div>
...
export default UserWithdrawalDetail
