...
const PLOManagement = () => {
    ...
    // List
    const { isLoading, isFetching, data } = useQuery(['PLOList', requestParams], () => getPLOList(requestParams), {
    ...
    useEffect(() => {
        document.title = 'PLO | Poker | PokerGold'
    }, [])
        ...
        <>
            ...
            <div>
                ...
                <CustomModal
                    ...
                    disableHeader
                    bodyTitle={location?.state?.endsWith('NLH') ? 'NLH Table' : 'PLO Table'}
                >
                    <article>
                        <h5>
                            <div>
